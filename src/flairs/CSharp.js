  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <Path
          d="M113 47.083c-36.395 0-65.917 29.522-65.917 65.917S76.605 178.917 113 178.917s65.917-29.522 65.917-65.917S149.395 47.083 113 47.083zm0 98.875c-18.174 0-32.958-14.784-32.958-32.958S94.826 80.042 113 80.042 145.958 94.826 145.958 113 131.174 145.958 113 145.958z"
          fill="#fff"
        />
        <Path
        ...
        />
        <Path
          d="M160.083 94.167h4.709v37.666h-4.709zm14.125 0h4.709v37.666h-4.709z"
          fill="#fff"
        />
        <Path
          d="M150.667 117.708h37.666v4.709h-37.666zm0-14.125h37.666v4.709h-37.666z"
          fill="#fff"
        />
      </G>
    </Svg>
