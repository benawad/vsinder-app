...
function SvgJulia(props) {
  return (
    <Svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 153.14 98.64"
      {...props}
    >
      <Defs></Defs>
      <G id="julia_svg__Layer_2" data-name="Layer 2">
        <G id="julia_svg__Layer_1-2" data-name="Layer 1">
          <G id="julia_svg__layer1">
            <G id="julia_svg__g3855">
              <G id="julia_svg__g945">
                <G id="julia_svg__g984">
                  <G id="julia_svg__g920">
                    <Path
                      id="julia_svg__path3804"
                      d="M93.14 80.94h-13V21.13l13-3.58z"
                      fill="#1a1a1a"
                    />
                    <G id="julia_svg__g898">
                      <G id="julia_svg__g893">
                        <Path
                          id="julia_svg__path19"
                          d="M22.17 36.33a8.9 8.9 0 118.9-8.9 8.91 8.91 0 01-8.9 8.9z"
                          fill="#4d64ae"
                        />
                      </G>
                      <Path
                        id="julia_svg__path3819"
